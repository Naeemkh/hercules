...
/*
	...
	double force_2 = -1*Force_2[timestep];

	double force_coefficient =    0.0470627768026632;

	double force_1x = force_1 * force_coefficient;
	double force_1z = force_1 * force_coefficient;

	double force_2x = force_2 * force_coefficient;
	double force_2z = force_2 * force_coefficient;
